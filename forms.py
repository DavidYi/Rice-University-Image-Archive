...
class SearchForm(ModelOrderedForm):
	tags = QuerySelectField('Tags', query_factory=tag_select_choices, allow_blank=True)
	folder = QuerySelectField('Folder', query_factory=folder_select_choices, allow_blank=True)
